/*
Deployment script for jholmAHgXP0dwSVt
...
GO
:setvar DatabaseName "jholmAHgXP0dwSVt"
:setvar DefaultFilePrefix "jholmAHgXP0dwSVt"
...
GO
PRINT N'Creating [ExchangeRatesData]...';


GO
CREATE SCHEMA [ExchangeRatesData]
    AUTHORIZATION [dbo];


GO
PRINT N'Creating [OrdersData]...';
...
GO
PRINT N'Creating [PaymentsData]...';


GO
CREATE SCHEMA [PaymentsData]
    AUTHORIZATION [dbo];


GO
PRINT N'Creating [PricingData]...';


GO
CREATE SCHEMA [PricingData]
    AUTHORIZATION [dbo];


GO
PRINT N'Creating [ReservationsData]...';


GO
CREATE SCHEMA [ReservationsData]
    AUTHORIZATION [dbo];


GO
PRINT N'Creating [ShowsData]...';
...
GO
PRINT N'Creating [TheatersData]...';


GO
CREATE SCHEMA [TheatersData]
    AUTHORIZATION [dbo];


GO
PRINT N'Creating [CustomerData].[Customers]...';
...
GO
PRINT N'Creating [EventsData].[Events]...';
...
GO
PRINT N'Creating [ExchangeRatesData].[ExchangeRates]...';
...
GO
PRINT N'Creating [OrdersData].[Orders]...';
...
GO
PRINT N'Creating [PaymentsData].[Payments]...';
...
GO
PRINT N'Creating [PricingData].[PricingRules]...';
...
GO
PRINT N'Creating [ReservationsData].[Reservations]...';
...
GO
PRINT N'Creating [ShowsData].[Shows]...';
...
GO
PRINT N'Creating [TheatersData].[Theaters]...';
...
GO
PRINT N'Creating FK_Events_Shows...';


GO
ALTER TABLE [EventsData].[Events] WITH NOCHECK
    ADD CONSTRAINT [FK_Events_Shows] FOREIGN KEY ([ShowID]) REFERENCES [ShowsData].[Shows] ([ID]);


GO
PRINT N'Creating FK_Reservations_Theaters...';


GO
ALTER TABLE [ReservationsData].[Reservations] WITH NOCHECK
    ADD CONSTRAINT [FK_Reservations_Theaters] FOREIGN KEY ([HallID]) REFERENCES [TheatersData].[Theaters] ([ID]);
